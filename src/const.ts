...
export const validGridDisconnected = [
	'off',
	'0',
	'off-grid',
	'off grid',
...
export const EDITOR_NAME = 'sunsynk-generator-dev-editor';
export const MAIN_NAME = 'sunsynk-generator-dev';
...
export const unitOfEnergyConversionRules: Record<
	UnitOfEnergyOrPower,
	ConversionRule[]
> = {
	[UnitOfEnergy.WATT_HOUR]: [
		{ threshold: 1e6, divisor: 1e6, targetUnit: UnitOfEnergy.MEGA_WATT_HOUR },
		{
			threshold: 1e3,
			divisor: 1e3,
	...
	[UnitOfEnergy.GIGA_JOULE]: [
		{ threshold: 1e3, divisor: 1e3, targetUnit: UnitOfEnergy.MEGA_JOULE },
	],
	[UnitOfEnergy.MEGA_JOULE]: [],
	[UnitOfPower.WATT]: [
		{ threshold: 1e6, divisor: 1e6, targetUnit: UnitOfPower.MEGA_WATT },
		{
			threshold: 1e3,
			divisor: 1e3,
